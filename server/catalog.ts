...
export interface CatalogDrop {id:number;name:string;slot:string;itemLevel?:number;boss:string;difficulty:string;track?:string;variantId?:string;bonusIds?:number[];simcFragment?:string;status:'verified'|'derived'|'missing'|'ambiguous'|'conflict';reason?:string}
