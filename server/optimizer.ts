...
export interface PlannedLoadout { name: string; source: 'bags'|'vault'|'advisor'; vaultCandidateId?: string; talent: TalentBuild; candidates: GearCandidate[]; }
