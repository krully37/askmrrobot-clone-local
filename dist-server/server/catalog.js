...
function installBundledCatalog() { if (existsSync(catalogPath) || !existsSync(bundledCatalogPath) || statSync(bundledCatalogPath).size === 0)
    return; copyFileSync(bundledCatalogPath, catalogPath); if (existsSync(bundledManifestPath))
    copyFileSync(bundledManifestPath, manifestPath); }
